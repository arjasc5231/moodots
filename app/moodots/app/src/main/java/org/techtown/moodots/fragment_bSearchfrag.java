...
public class fragment_bSearchfrag extends Fragment implements OnBackPressedListener{
    ...
    fragment_sub_cmoodfragment moodfragment=new fragment_sub_cmoodfragment();
    fragment_sub_ckeywordfragment keywordfragment= new fragment_sub_ckeywordfragment();
