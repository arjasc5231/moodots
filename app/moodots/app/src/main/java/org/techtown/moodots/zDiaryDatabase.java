...
public class zDiaryDatabase {
    private static final String TAG = "DiaryDatabase";
    private static zDiaryDatabase database;
    public static String TABLE_DIARY = "DIARY";
    public static int DATABASE_VERSION = 1;
    private DatabaseHelper dbHelper;
    private SQLiteDatabase db;
    private Context context;
    private zDiaryDatabase(Context context) {
        this.context = context;
    }
    public static zDiaryDatabase getInstance(Context context) {
        if (database == null) {
            Log.d(TAG, "database is null in recent");
            database = new zDiaryDatabase(context);
        }
        return database;
    }
