...
public class astart_activity_BootCompleteReceiver extends BroadcastReceiver {
    private final static String TAG = astart_activity_BootCompleteReceiver.class.getSimpleName();
        ...
        if (action.equals("android.intent.action.BOOT_COMPLETED")) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                @Override public void run() {
                    ...
                    // BackgroundService
                    Intent serviceLauncher = new Intent(context, service_MyService.class);
