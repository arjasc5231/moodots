...
public class fragment_sub_cmonthfragment extends Fragment {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth){
                        ...
                        btnYearMonthPicker.setText(chooseyear+"-"+choosemonth);
                        ArrayList<zDiary> temp= bringdata(year, monthOfYear);
    ...
    public ArrayList<zDiary> bringdata(int year, int month){
    ...
    public void scatterchart(ViewGroup rootView, ArrayList<zDiary> percent){
