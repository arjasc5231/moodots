...
public class fragment_sub_ckeywordfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<zDiary> first=loadfirstdata();
    ...
    public void initUI(ViewGroup rootView, HashSet hashSet){
        ...
        if(iter.hasNext()){
            ...
            ArrayList<zDiary> percent= bringdata(hash);
    ...
    public ArrayList<zDiary> bringdata(String hash){
        ArrayList<zDiary> percent=new ArrayList<zDiary>();
        String sql = "SELECT _id, MOOD, CONTENTS, HASHCONTENTS, CHECKMOD, DATE, TIME, VOICE FROM " + zDiaryDatabase.TABLE_DIARY +" WHERE HASHCONTENTS LIKE '%"+hash+"%' ORDER BY DATE DESC;";
        int recordCount= 0;
    ...
    public ArrayList<zDiary> loadfirstdata(){
        ArrayList<zDiary> percent=new ArrayList<zDiary>();
