...
public class fragment_sub_cweekfragment extends Fragment {
    PieChart pieChart;
    ...
    public void initUI(ViewGroup rootView){
        ArrayList<zDiary> percent= bringdata(chooseyear, choosemonth,chooseday );
        ...
        date.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                zYearMonthWeekPickerDialog pd = new zYearMonthWeekPickerDialog();
                DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int week){
                        ...
                        ArrayList<zDiary> temp= bringdata(year, monthOfYear, startday);
    ...
    public ArrayList<zDiary> bringdata(int year, int month, int day){
